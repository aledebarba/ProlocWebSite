...
const items = [
  {
    ...
    altText: 'Sala de família classe média, em São Paulo.',
    caption: 'Sala classe média, São Paulo',
    header: 'Ambientes internos'
  },
  {
